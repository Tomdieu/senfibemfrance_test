...
export default function ProfessionnelSubscriptionPage() {
    const t = useScopedI18n('subscriptions.plans.professionnel')
        ...
        <SubscriptionPageLayout title={t('title')} subtitle={t('subtitle')}>
            <div className="max-w-md mx-auto">
                <PricingCard
                    ...
                    popular={true}
                    onSelect={() => router.push('/inscription?type=professionnels')}
                />
            </div>
