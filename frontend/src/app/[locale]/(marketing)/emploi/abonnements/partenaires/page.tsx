...
export default function PartenaireSubscriptionPage() {
    const t = useScopedI18n('subscriptions.plans.partenaire')
        ...
        <SubscriptionPageLayout title={t('title')} subtitle={t('subtitle')}>
            <div className="max-w-md mx-auto">
                <PricingCard
                    ...
                    popular={true}
                    onSelect={() => router.push('/inscription?type=partenaires')}
                />
            </div>
