...
export default function ConnexionPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    // Handle login logic
    console.log({ selectedType, email, password, rememberMe })
  }
      ...
      <div className="max-w-md mx-auto px-4">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-fibem-secondary focus:border-transparent"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full pl-10 pr-12 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-fibem-secondary focus:border-transparent"
                />
                <button
                  type="button"
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  ...
                  className="w-4 h-4 rounded border-gray-300 text-fibem-primary focus:ring-fibem-secondary"
                />
            ...
            <button
              type="submit"
              className="w-full py-3 bg-fibem-primary text-white font-semibold rounded-lg hover:bg-fibem-dark transition-colors"
            >
              Se connecter
            </button>
          </form>
          ...
          <div className="space-y-3">
            <button className="w-full py-3 border border-gray-300 rounded-lg flex items-center justify-center gap-3 hover:bg-gray-50 transition-colors">
